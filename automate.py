...
# ============= EDIT THESE =============
embedded_path   = "/mnt/e/Quartus/embedded/" # Path to the embedded directory
HPS_IP_ADDRESS  = "192.168.50.232"           # IP address of the HPS, use udhcpc -r ADDRESS to request a specific IP address. Use ifconfig to check the IP address.
TARGET_NAME     = "my_first_hps"             # Name of the executable that will be generated by the Makefile
# ======================================
